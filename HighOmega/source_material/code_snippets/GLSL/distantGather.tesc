...
void main() 
{
	...
	if (ID == 0)
	{
		gl_TessLevelInner[0] = int (InterpSubdivAmount);
		gl_TessLevelOuter[0] = InterpSubdivAmount;
		gl_TessLevelOuter[1] = InterpSubdivAmount;
		gl_TessLevelOuter[2] = InterpSubdivAmount;
	}
}
